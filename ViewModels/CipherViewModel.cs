...
namespace CryptThor.ViewModels
{
    public class CipherViewModel : INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Updates texts when switched to different language
        /// </summary>
        ...
        public void ToCaesar()
        {
            ...
            } else
            {
                ...
                DescriptionInputTextUsage =
                    "Removes diacritic. \n" +
                    "Other non-letter characters including whitespace characters remain, but they are not encrypted.";
                DescriptionKeyUsage =
                    "Converted to lowercase English alphabet. \n" +
        ...
        public void ToVernam()
        {
            ...
            } else
            {
                ...
                DescriptionKeyUsage =
                    "Converted to lowercase English alphabet. \n" +
                    "Must contain as many characters as input text. If you left key empty, you will get generated (pseudo) random key.";
                DescriptionPrinciple = "";
                DescriptionHistory = "";
            }
        ...
        public void ToScytale()
        {
            ...
            {
                Caption = "Scytale";
                DescriptionInputTextUsage = "No restrictions.";
                DescriptionKeyUsage = "Must be a number.";
                DescriptionPrinciple = "";
                DescriptionHistory = "";
            }
        ...
        public void ToMorse()
        {
            ...
            } else
            {
                ...
                DescriptionInputTextUsage =
                    ...
                    "Encodes English alphabet and the following characters: ? , ! . ; / = - ( ) : + _ @";
                DescriptionKeyUsage = "Does not use key.";
                DescriptionPrinciple = "";
                DescriptionHistory = "";
            }
        ...
        void Caesar(bool encrypt, string inputText, string key)
        {
            if (key.Length != 1)
            {
                string errorMsg;
                if (Language == "cs")
                    errorMsg = "Klíč musí obsahovat právě 1 znak.";
                else
                    errorMsg = "Key must contain exactly 1 character";
        ...
        void Vernam(bool encrypt, string inputText, string key)
        {
            if ((key != string.Empty || !encrypt) && inputText.Length != key.Length)
            {
                string errorMsg;
                if (Language == "cs")
                    errorMsg = "Klíč musí být stejně dlouhý jako vstupní text.";
                else
                    errorMsg = "Key must have as many characters as input text.";
